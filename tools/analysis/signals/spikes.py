...
from tools.visualization import spikes as spk_plots, helper
from tools import operations
from tools.analysis import metrics, signals
from tools.logger import data_io as data_handling
...
class SpikeList(object):
    ...
    def id_slice(self, id_list, re_number=False):
        """
        ...
        for id_n, id_ in enumerate(id_list):
            try:
                if re_number:
                    new_SpkList.append(id_n, self.spiketrains[id_])
                else:
